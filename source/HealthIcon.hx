...
class HealthIcon extends FlxSprite
{
	...
	{
		super();
		loadGraphic('assets/images/iconGridButcool.png', true, 150, 150);

		antialiasing = true;
		animation.add('bf-mad', [0, 1], 0, false, isPlayer);
		...
		animation.add('spirit-n', [28, 29], 0, false, isPlayer);
		animation.add('spirit-n-glitch', [28, 29], 0, false, isPlayer);
